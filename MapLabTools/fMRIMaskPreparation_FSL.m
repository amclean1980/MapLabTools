...
% NOTE:  THIS IS JUST RSATOOLBOX VERSION BUT INSTEAD OF LOADING SPM FILE IT
%        LOADS A NIFTI FILE.  I ONLY CHANGED LINES 86-88!!!!!
%
...
if overwriteFlag
	...
	for subjectNumber = 1:nSubjects % and for each subject...
      ...
      maskMatrix = nii.img;
			...
			binaryMasks_nS.(subject).(maskLabel) = maskMatrix;
			clear maskMatrix;
